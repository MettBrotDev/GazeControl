...
\title{GazeControl: Computational modeling of human vision and decision making for visual reasoning tasks}
\date{\today}
...
% Removed Kurzfassung (German summary) per request
...
\include{chapter/foundation}
\include{chapter/methodology}
\include{chapter/results}
\include{chapter/limitations}
